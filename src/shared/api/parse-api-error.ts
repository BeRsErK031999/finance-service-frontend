...
const API_ERROR_MESSAGES: Record<string, string> = {
  ...
  FILE_ACCESS_DENIED:
    'У вас нет доступа к файлам этой записи.',
  FILE_NAME_INVALID:
    'Имя файла не прошло проверку. Переименуйте файл и попробуйте снова.',
  FILE_NOT_EDITABLE:
    'Файлы этой записи сейчас недоступны для изменения.',
  FILE_NOT_FOUND: 'Файл не найден.',
  FILE_ORDER_CONFLICT:
    'Список файлов уже изменился. Обновите данные и повторите действие.',
  FILE_PARENT_NOT_FOUND:
    'Запись, к которой добавляется файл, не найдена.',
  FILE_TOO_LARGE:
    'Файл превышает допустимый размер 20 МБ.',
  FILE_TYPE_NOT_ALLOWED:
    'Этот формат файла не поддерживается. Используйте PDF, PNG, JPG, DOC, DOCX, XLS или XLSX.',
  FILE_UPLOAD_FAILED:
